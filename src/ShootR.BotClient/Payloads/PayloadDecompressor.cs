...
namespace ShootR.BotClient.Payloads
{
    ...
    {
        public PayloadDecompressor(InitializationData clientInitializationData)
        {
            PayloadContract = (JObject)clientInitializationData.CompressionContracts["PayloadContract"];
            /*
             * {
             *  PayloadContract: {
             *  }
             * }
             * */
            //PayloadContract = clientInitializationData.CompressionContracts["PayloadContract"];
        }


        public JObject PayloadContract { get; }

        public JObject CollidableContract { get; }

        public JObject ShipContract { get; }

        public JObject BulletContract { get; }

        public JObject LeaderboardEntryContract { get; }

        public JObject PowerupContract { get; }
